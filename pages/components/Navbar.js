...
export default function Navbar() {
  ...
  return (
    <nav className="flex items-center justify-between p-6 w-full">
      <a
        className="flex items-center dark:text-white text-gray-800 hover:text-blue-600"
        href="#"
      >
        <svg
          className="w-6 h-6"
      ...
      <div className="block md:hidden">
        <button className="flex items-center px-3 py-2 border rounded text-teal-200 border-teal-400 hover:text-blue-600 hover:border-white">
          <svg
      ...
      <div className="w-full hidden md:flex flex-grow items-center lg:w-auto">
        <div className="text-sm md:flex-grow">
          <a
            href="/demos"
            className="mt-4 inline-block lg:mt-0 text-teal-200 hover:text-blue-600 mr-4"
          >
            Demos
          </a>
          <a
          ...
          <a
            href="#responsive-header"
            className="mt-4 inline-block lg:mt-0 text-teal-200 hover:text-blue-600"
          >
            Snippets
          </a>
        </div>
